...
| CI2 | `ubuntu-latest`/`macos-latest`/`windows-latest` 为滚动标签；ARM 原生 runner 仍需架构专用标签 | [官方 runner 表][runners]、[镜像标签][runner-images] / rolling | GitHub 文档核验；2026-09-23 常规 CI run 35871630941 的 18 个 job 与 v2.0.1 发布 run 35874108129 的 20 个 job 全通过，8 个核心及 3 个扩展包均构建成功 | build.yml 矩阵 |
