...
| --- | --- | --- |
| C01 | 目标：理解、开发、修复、测试、文档、部署、路线图与计划 | [工程流程][engineering]、[Rust Skill][rust]；Rust 实现已建立 |
...
| C16 | 部署、CI 和供应链 | [安全与交付][security]、[验证记录][validation]：短期凭据、最小权限、完整 SHA、不可信 PR 隔离、制品/迁移/健康/回滚 |
...
| C24 | 文档、路线图、计划和交接 | [工程流程][engineering]：按需索引、职责区分、同步引用/图示、未实现状态与交接证据 |
