...
1. 启用新的项目图标和横幅；Windows 可执行文件嵌入多尺寸应用图标及版本信息。

2.0.1
------

1. 修复旧 Python 入口从 GitHub Releases 下载时拒绝仓库规范地址 `owent/xresconv-cli` 的问题；保留旧组织地址兼容，并补充两种地址的离线回归测试与公开 Release 下载验收。
...
7. GitHub Actions：Linux/macOS/Windows 原生测试、8 个核心构建目标与 3 个扩展目标；tag 通过完整门禁后自动发布预编译包及校验和
